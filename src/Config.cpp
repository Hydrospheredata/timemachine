...
Config::Config()
{
    ...
    sourceLocalDir = getEnvironmentVariableOrDefault("SRC_LOCAL_DIR", (char *)"default");
    dbName = getEnvironmentVariableOrDefault("AWS_BUCKET_NAME", (char *)"default");
    keyid = getEnvironmentVariableOrDefault("AWS_ACCESS_KEY_ID", (char *)"none");
    secret = getEnvironmentVariableOrDefault("AWS_SECRET_ACCESS_KEY", (char *)"none");
    kRegion = getEnvironmentVariableOrDefault("AWS_DEFAULT_REGION", (char *)"us-west-2");
    destinationLocalDir = getEnvironmentVariableOrDefault("DST_LOCAL_DIR", (char *)"default");
    sourceBucket = getEnvironmentVariableOrDefault("SRC_BUCKET", (char *)"default");
    destBucket = getEnvironmentVariableOrDefault("DST_BUCKET", (char *)"default");
